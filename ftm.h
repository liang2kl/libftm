 ...
 * @prefix: prefix of identifiers defined in
 * nl80211.h, like NL80211_ATTR_
 * @attr_idx: suffix of identifiers defined in
 * nl80211.h, like CHANNEL_WIDTH
 * @attr_name: variable name of ftm_peer_attr
 * @type: data type of the attribute, capitalized,
 * like U8
 * 
 * Be sure that msg is in the correct hierarchy of
 * nested attributes.
 */
 ...
 * 
 * This is a helper definition specified 
 * for setting attribute defined in
 ...
 * 
 * Be sure that msg is in the correct hierarchy of
 * nested attributes. Flag attributes are defined
 * in nl80211.h.
 */
...
/**
 * FTM_PUT_PUT_FLAG - Set flag attributes for a peer
 * 
 * This is a helper definition specified 
 * for setting attribute defined in
 * @enum l80211_peer_measurement_ftm_req.
...
/**
 * FTM_GET - Get attributes from given nlattr pointer
 * and store in given resp_attr instance
 * 
 ...
 * like U8
 * 
 * Don't use this definition to get mac_addr. Use
 * FTM_GET_ADDR instead.
 */
...
/**
 * FTM_GET_ADDR - Copy mac address of the peer into
 * given ftm_resp_attr instance
 * 
 ...
 * @attr_name: variable name of ftm_resp_attr
 * @specifier: specifier used in printf() for the type
 * 
 * Don't use this definition to print mac_addr. Use
 * FTM_PRINT_ADDR instead.
 */
